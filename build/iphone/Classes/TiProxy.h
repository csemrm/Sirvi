...
//Rare exceptions to indicate a bug in the _mconciergenew code (Eg, function that a subclass should have implemented)
...
/**
 The base class for MConciergeNew proxies.
 */
