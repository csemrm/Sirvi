...
//@interface MConciergeNewObject : NSObject
//@end

@interface MConciergeNewObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[MConciergeNewObject class]])
		{
			for (NSString *key in [[(MConciergeNewObject*)o modules] allKeys])
			{
