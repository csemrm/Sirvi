...
// in simulator we redefine to format for MConciergeNew Developer console
...
{\
	NSString * exceptionName = [@"org.mconciergenew." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.mconciergenew";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIMConciergeNewNativeItemNone = -1, 
	UIMConciergeNewNativeItemSpinner = -2,
	UIMConciergeNewNativeItemProgressBar = -3,
	
	UIMConciergeNewNativeItemSlider = -4,
	UIMConciergeNewNativeItemSwitch = -5,
	UIMConciergeNewNativeItemMultiButton = -6,
	UIMConciergeNewNativeItemSegmented = -7,
	
	UIMConciergeNewNativeItemTextView = -8,
	UIMConciergeNewNativeItemTextField = -9,
	UIMConciergeNewNativeItemSearchBar = -10,
	
	UIMConciergeNewNativeItemPicker = -11,
	UIMConciergeNewNativeItemDatePicker = -12,
	
	UIMConciergeNewNativeItemInfoLight = -13,
	UIMConciergeNewNativeItemInfoDark = -14,
	
	UIMConciergeNewNativeItemDisclosure = -15,
	
	UIMConciergeNewNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all MConciergeNew instances of
