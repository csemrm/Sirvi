...
// in simulator we redefine to format for Sirvi Developer console
...
{\
	NSString * exceptionName = [@"org.sirvi." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.sirvi";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UISirviNativeItemNone = -1, 
	UISirviNativeItemSpinner = -2,
	UISirviNativeItemProgressBar = -3,
	
	UISirviNativeItemSlider = -4,
	UISirviNativeItemSwitch = -5,
	UISirviNativeItemMultiButton = -6,
	UISirviNativeItemSegmented = -7,
	
	UISirviNativeItemTextView = -8,
	UISirviNativeItemTextField = -9,
	UISirviNativeItemSearchBar = -10,
	
	UISirviNativeItemPicker = -11,
	UISirviNativeItemDatePicker = -12,
	
	UISirviNativeItemInfoLight = -13,
	UISirviNativeItemInfoDark = -14,
	
	UISirviNativeItemDisclosure = -15,
	
	UISirviNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Sirvi instances of
