...
/**
 Base class for all MConciergeNew views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the MConciergeNew view hierarchy (such as wrapped iOS UIViews) was touched.
