...
@interface MConciergeNewObject : KrollCoverageObject {
#else
@interface MConciergeNewObject : KrollObject {
#endif
@private
...
extern NSString * MConciergeNew$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	MConciergeNewObject *_mconciergenew;
    KrollObject* console;
	BOOL shutdown;
